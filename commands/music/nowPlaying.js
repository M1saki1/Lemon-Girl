module.exports = {
    ...
    execute(client,message) {
        if (!message.member.voice.channel) return message.channel.send(`${client.emotes.error} - You are nor in a voice channel!`);

        if (message.guild.me.voice.channel && message.member.voice.channle.id !== message.guild.me.voice.channle.id) return message.channel.send(`${client.emotes.error} - You are not in the same voice channel !`);
